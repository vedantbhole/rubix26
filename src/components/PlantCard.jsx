  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 overflow-hidden">
        ...
        <Link
          to={`/plant/${plant.id}`}
          className="absolute bottom-4 right-4 w-10 h-10 rounded-xl bg-herb-500/90 text-white flex items-center justify-center opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300"
        >
